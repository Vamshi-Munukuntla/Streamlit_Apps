...
st.write("This app uses 6 inputs to predict the species of penguins using "
         "a model built on the Palmer's penguin's dataset. "
         "Use the form below to get started!")
penguin_file = st.file_uploader('Upload your own penguin data')
if penguin_file is None:
    rf_pickle = open(path + r'\random_forest_penguin.pickle', 'rb')
    map_pickle = open(path + r'\output_penguin.pickle', 'rb')
...
st.write('Below are the histograms for each continuous variable separated'
         'by penguin species. The vertical line represents your the '
         'inputted value.')
